...
public class DummiestBotModel extends ExecutionModelImpl {

    public DummiestBotModel() {

        /*
         * Define the intents our bot will react to.
         */
        val iAm1 = intent("IAm1")
        ...
        awaitingInput
                 ...
                 * </pre>
                 */
                .when(intentIs(iAm1)).moveTo(handleIAm)
                .when(intentIs(iAm2)).moveTo(handleYouAre);
