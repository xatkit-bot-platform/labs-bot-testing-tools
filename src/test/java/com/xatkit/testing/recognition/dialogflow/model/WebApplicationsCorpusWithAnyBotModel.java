...
public class WebApplicationsCorpusWithAnyBotModel extends ExecutionModelImpl {


    public WebApplicationsCorpusWithAnyBotModel(){
        ...
        val FindAlternative = intent("FindAlternative")
                ...
                .parameter("WebService").fromFragment("WebService").entity(any())
